...
`https://github.com/DataXquad-HQ/busycow-agent-package/blob/main/artifacts/shared-skills/twenty-crm/SKILL.md`

CRM schema (object/field definitions) at:
`https://github.com/DataXquad-HQ/busycow-agent-package/blob/main/artifacts/schemas/crm.md`

Install guide at:
`https://github.com/DataXquad-HQ/busycow-agent-package/blob/main/playbooks/integrations/twenty-crm/SETUP.md`
